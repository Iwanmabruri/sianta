...
>>>>>>> 3d9d762fdc34c39896cb8f716d71df1346d3ebc3
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-0 col-md-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="thn_ajr"
                                            name="thn_ajr" required>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col d-flex justify-content-center">
                                            <button type="button" class="btn btn-primary float-end">simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
